...
/**
 * @brief Base button class with theme support
 */
...
/**
 * @brief Primary button with accent color
 */
...
/**
 * @brief Clear button with X icon
 */
...
/**
 * @brief Rotate button with animation
 */
...
/**
 * @brief File button for opening file dialogs
 */
...
public:
    ...
    void setFileDialog(QWidget *parent, QFileDialog::FileMode mode,
...
/**
 * @brief Menu button that shows a dropdown menu
 */
...
/**
 * @brief Hollow button (transparent background)
 */
...
/**
 * @brief Navigation button with exclusive selection
 */
