...
/**
 * @brief Main window class with QMainWindow integration and frameless functionality
 */
...
public:
    ...
    QGridLayout *centralLayout() const { return m_centralLayout; }
...
/**
 * @brief Child window that can be modal and has event loop execution
 */
...
public:
    explicit ChildWindowBase(QWidget *parent = nullptr,
